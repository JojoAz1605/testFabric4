...
import net.test_fabric.blocks.ASuivre;
...
public class Mod implements ModInitializer {
	...
	public void onInitialize() {
		...
		Registry.register(Registry.BLOCK, new Identifier("test_fabric", "a_suivre"), Mod.A_SUIVRE);
		Registry.register(Registry.ITEM, new Identifier("test_fabric", "a_suivre"), new BlockItem(Mod.A_SUIVRE, new FabricItemSettings().group(Mod.MON_GROUPE)));



		Registry.register(Registry.SOUND_EVENT, Mod.TO_BE_CONTINUED, TO_BE_CONTINUED_SOUND_EVENT);
